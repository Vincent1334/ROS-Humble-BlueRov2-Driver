...
{
  new (message_memory) bluerov2_msgs::msg::SetTarget(_init);
}

void SetTarget_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bluerov2_msgs::msg::SetTarget *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetTarget_message_member_array[3] = {
  {
    ...
    offsetof(bluerov2_msgs::msg::SetTarget, depth_desired),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bluerov2_msgs::msg::SetTarget, roll_desired),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bluerov2_msgs::msg::SetTarget, pitch_desired),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetTarget_message_members = {
  ...
  3,  // number of fields
  sizeof(bluerov2_msgs::msg::SetTarget),
...
get_message_type_support_handle<bluerov2_msgs::msg::SetTarget>()
{
  return &::bluerov2_msgs::msg::rosidl_typesupport_introspection_cpp::SetTarget_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bluerov2_msgs, msg, SetTarget)() {
  return &::bluerov2_msgs::msg::rosidl_typesupport_introspection_cpp::SetTarget_message_type_support_handle;
}
