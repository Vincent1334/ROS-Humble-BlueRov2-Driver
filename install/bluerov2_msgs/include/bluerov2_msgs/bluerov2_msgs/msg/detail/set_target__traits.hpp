...
#ifndef BLUEROV2_MSGS__MSG__DETAIL__SET_TARGET__TRAITS_HPP_
#define BLUEROV2_MSGS__MSG__DETAIL__SET_TARGET__TRAITS_HPP_
...
inline void to_yaml(
  const bluerov2_msgs::msg::SetTarget & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bluerov2_msgs::msg::SetTarget & msg)
{
  return bluerov2_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bluerov2_msgs::msg::SetTarget>()
{
  return "bluerov2_msgs::msg::SetTarget";
}

template<>
inline const char * name<bluerov2_msgs::msg::SetTarget>()
{
  return "bluerov2_msgs/msg/SetTarget";
}

template<>
struct has_fixed_size<bluerov2_msgs::msg::SetTarget>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<bluerov2_msgs::msg::SetTarget>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<bluerov2_msgs::msg::SetTarget>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BLUEROV2_MSGS__MSG__DETAIL__SET_TARGET__TRAITS_HPP_
