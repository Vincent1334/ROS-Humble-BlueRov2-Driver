...
bluerov2_interfaces__msg__SetTarget__create()
{
  ...
  bluerov2_interfaces__msg__SetTarget * msg = (bluerov2_interfaces__msg__SetTarget *)allocator.allocate(sizeof(bluerov2_interfaces__msg__SetTarget), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bluerov2_interfaces__msg__SetTarget));
  bool success = bluerov2_interfaces__msg__SetTarget__init(msg);
  if (!success) {
...
bluerov2_interfaces__msg__SetTarget__destroy(bluerov2_interfaces__msg__SetTarget * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    bluerov2_interfaces__msg__SetTarget__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bluerov2_interfaces__msg__SetTarget__Sequence__init(bluerov2_interfaces__msg__SetTarget__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bluerov2_interfaces__msg__SetTarget * data = NULL;

  if (size) {
    data = (bluerov2_interfaces__msg__SetTarget *)allocator.zero_allocate(size, sizeof(bluerov2_interfaces__msg__SetTarget), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bluerov2_interfaces__msg__SetTarget__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bluerov2_interfaces__msg__SetTarget__fini(&data[i - 1]);
      }
...
bluerov2_interfaces__msg__SetTarget__Sequence__fini(bluerov2_interfaces__msg__SetTarget__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bluerov2_interfaces__msg__SetTarget__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bluerov2_interfaces__msg__SetTarget__Sequence * array = (bluerov2_interfaces__msg__SetTarget__Sequence *)allocator.allocate(sizeof(bluerov2_interfaces__msg__SetTarget__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bluerov2_interfaces__msg__SetTarget__Sequence__init(array, size);
  if (!success) {
...
bluerov2_interfaces__msg__SetTarget__Sequence__destroy(bluerov2_interfaces__msg__SetTarget__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bluerov2_interfaces__msg__SetTarget__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bluerov2_interfaces__msg__SetTarget__Sequence__are_equal(const bluerov2_interfaces__msg__SetTarget__Sequence * lhs, const bluerov2_interfaces__msg__SetTarget__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bluerov2_interfaces__msg__SetTarget__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bluerov2_interfaces__msg__SetTarget__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bluerov2_interfaces__msg__SetTarget);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bluerov2_interfaces__msg__SetTarget * data =
      (bluerov2_interfaces__msg__SetTarget *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bluerov2_interfaces__msg__SetTarget__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bluerov2_interfaces__msg__SetTarget__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bluerov2_interfaces__msg__SetTarget__copy(
