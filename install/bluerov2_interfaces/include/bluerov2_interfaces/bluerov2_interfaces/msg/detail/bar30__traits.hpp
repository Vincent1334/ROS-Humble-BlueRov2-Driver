...
#ifndef BLUEROV2_INTERFACES__MSG__DETAIL__BAR30__TRAITS_HPP_
#define BLUEROV2_INTERFACES__MSG__DETAIL__BAR30__TRAITS_HPP_
...
inline void to_yaml(
  const bluerov2_interfaces::msg::Bar30 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bluerov2_interfaces::msg::Bar30 & msg)
{
  return bluerov2_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bluerov2_interfaces::msg::Bar30>()
{
  return "bluerov2_interfaces::msg::Bar30";
}

template<>
inline const char * name<bluerov2_interfaces::msg::Bar30>()
{
  return "bluerov2_interfaces/msg/Bar30";
}

template<>
struct has_fixed_size<bluerov2_interfaces::msg::Bar30>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<bluerov2_interfaces::msg::Bar30>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<bluerov2_interfaces::msg::Bar30>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BLUEROV2_INTERFACES__MSG__DETAIL__BAR30__TRAITS_HPP_
