...
#ifndef BLUEROV2_INTERFACES__MSG__DETAIL__SET_DEPTH__TRAITS_HPP_
#define BLUEROV2_INTERFACES__MSG__DETAIL__SET_DEPTH__TRAITS_HPP_
...
inline void to_yaml(
  const bluerov2_interfaces::msg::SetDepth & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bluerov2_interfaces::msg::SetDepth & msg)
{
  return bluerov2_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bluerov2_interfaces::msg::SetDepth>()
{
  return "bluerov2_interfaces::msg::SetDepth";
}

template<>
inline const char * name<bluerov2_interfaces::msg::SetDepth>()
{
  return "bluerov2_interfaces/msg/SetDepth";
}

template<>
struct has_fixed_size<bluerov2_interfaces::msg::SetDepth>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<bluerov2_interfaces::msg::SetDepth>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<bluerov2_interfaces::msg::SetDepth>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BLUEROV2_INTERFACES__MSG__DETAIL__SET_DEPTH__TRAITS_HPP_
